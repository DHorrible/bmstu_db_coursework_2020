...
query_2 = Button('Показать количество переводов с каждого из счетов клиента по фамилии "Petrov"', 'query/2')
query_3 = Button('Показать общую сумму переводов на заданный счет клиента', 'query/3')
